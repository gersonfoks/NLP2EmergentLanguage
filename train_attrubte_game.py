...
from attribute_game.models import FeatureEncoder, SenderRnn, ReceiverRnn, ReceiverFixed, SenderFixed
...
sender = SenderFixed(feature_encoder_sender, msg_len=msg_len, n_symbols=n_symbols).to(device)
